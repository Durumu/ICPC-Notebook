...
\begin{itemize}
	...
	\item \code{[length]} has many features, most obsolete. For competitive programming, the only notable feature is \code{ll}, which allows \code{ll}s to be used instead of \code{int}s.
\end{itemize}
